...
int main(void)
{
  ...
  /* USER CODE BEGIN 3 */
//		wave_form_data[0] =motor_pid[0].output;
//	  wave_form_data[1] =motor_pid[1].output;
//	  wave_form_data[2] =remote_control.switch_left;
//	  wave_form_data[3] =remote_control.switch_right;
//	  wave_form_data[4] =motor_pid[3].output;//moto_chassis[6].total_angle;//moto_chassis[0].real_current;
//	  wave_form_data[5] =motor_pid[4].output;//moto_chassis[6].real_current;//moto_chassis[0].hall;
		
		
		wave_form_data[0] =aacx;
	  wave_form_data[1] =Pitch;
	  wave_form_data[2] =gyrox;
	  wave_form_data[3] =gyroy;
	  wave_form_data[4] =(short)imu.ax;
	  wave_form_data[5] =(short)imu.ay;
